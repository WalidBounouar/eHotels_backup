...
function loadViews() {
    ...
    var reqURL = apiURL + "/rooms/freeRoomsPerArea";
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": reqURL,
...
function renderSearch(response) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        var number = currentResult.numberOfRooms;
        var address = currentResult.city + ", " + currentResult.state;
            ...
            <div id="wrapper" class="container listitem-container">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="row listitem-row">
                            <span class="listitem-label">Free Rooms:&nbsp;</span>
